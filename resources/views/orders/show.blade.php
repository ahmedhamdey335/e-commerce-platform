    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <nav class="flex text-sm text-gray-500 dark:text-gray-400 mb-4" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                <li><a href="{{ route('orders.index') }}" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">My Orders</a></li>
                <li>
    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                            ...
                            <div class="flex justify-between">
                                <div>
                                    <h3 class="text-base font-medium text-gray-900 dark:text-white">
                                        @if($item->product)
                                            <a href="{{ route('products.show', ['id' => $item->product->id]) }}" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                                {{ $item->product->name }}
                                            </a>
                                        @else
        ...
        <div class="mt-8 lg:mt-0 lg:col-span-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 sticky top-24">
                ...
                <div class="mt-6">
                    <a href="{{ route('orders.index') }}" class="w-full flex items-center justify-center px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                        ← Back to Orders
                    </a>
                </div>
            </div>
